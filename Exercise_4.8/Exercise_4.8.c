/* Exercise 4.8 from K&R */
/* Suppose, that number of returned into input symbols is'n higher than 1. Modify getch and ungetch using this fact*/
...
void ungetch(int c) /* return symbol to input */
{
    if(buf != EOF)
        printf("too many characters, buffer is full");
    else
        buf = c;
}
